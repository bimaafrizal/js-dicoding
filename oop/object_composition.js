//pendekatan oop berdasarkan kemampuan yang dapat dilakukan
class Developer {
    constructor(name) {
      this.name = name;
    }
  ...
  const frontEndDeveloper = createFrontEndDeveloper('Fulan front');
...
const backEndDeveloper = createBackEndDeveloper('Fulana back');
...
const devOpsDeveloper = createDevOps('Fulani dev');
...
const fullStackDeveloper = createFullStackDeveloper('Fulanah full');
